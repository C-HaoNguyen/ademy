                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-slate-300 pl-9 pr-3 py-2 text-sm
                                           focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors duration-200"
                            />
                        </div>
                        <button
                            type="button"
                            onClick={onApplyCoupon}
                            className="cursor-pointer rounded-xl bg-primary px-4 py-2 text-sm text-white hover:bg-primary-dark transition-colors duration-200"
                        >
                            Áp dụng
                        </button>
                    </div>
